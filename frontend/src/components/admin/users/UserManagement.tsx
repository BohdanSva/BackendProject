...
import { selectData, setData } from "../../../features/account/accountSlice";
import '../admin.css';
...
const UserManagement = () => {
  ...
  // Functions
  const getData = async () => {
    const dataURL = `http://localhost:3001/admin/users`;
    try {
    ...
    <div className="container">
      ...
      <div className="row">
        <div className="col mb-5">
          <h2 className="title"> You have no users </h2>
        </div>
      </div>
    </div>
    </div>
    ...
    <div className="container">
      ...
      <div className="row">
        <div className="col mb-4">
          <h2 className="title"> App user base </h2>
          <p>User count: {filteredData.length}</p>        
        </div>
